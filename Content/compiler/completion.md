...
A [union](xref:language.unions) offers its cases through `::`, since that is
...
A [pattern](xref:language.unions#reading-a-value) and a
[case written without its union](xref:language.unions#leaving-the-union-out)
